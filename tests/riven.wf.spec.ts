...
before(() => {
  setGlobalItem(testItem.data);
  setGlobalRivenAttribute(testAttr.data);
});

describe("OCR Result Tests", function () {
  const results = [
    {
...
describe("Transform Riven Calc Data Tests", function () {
  it("", () => {
    let count = 0;
...
describe("Transform Attr Base Value Tests", function () {
  it("Weapon Names", () => {
    const names = ["MK1-盗贼", "悦音", "达克拉", "赤毒 食人女魔", "雷克斯"];
