...
describe('wfm-service.inputToItem', () => {
  ...
  const aliasCases = [
    ...
    { input: '工程统帅', slug: 'vauban_prime_set' },
    { input: '惊涛骇浪', slug: 'hydroid_prime_set' },
    { input: '沙甲', slug: 'inaros_prime_set' },
    { input: '蝶甲', slug: 'titania_prime_set' },
    { input: '驱魔使者', slug: 'harrow_prime_set' },
    { input: '琉璃侍女', slug: 'gara_prime_set' },
    { input: '圣拳武僧', slug: 'baruuk_prime_set' },
    { input: '电光舞者', slug: 'gyre_prime_set' },
  ]
