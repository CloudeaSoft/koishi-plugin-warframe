...
describe('wfm-service.inputToItem', () => {
  ...
  const aliasCases = [
    ...
    { input: '缴械基', slug: 'loki_prime_set' },
    { input: '弱鸡', slug: 'loki_prime_set' },
    { input: '阿屎', slug: 'ash_prime_set' },
    { input: '开门娃', slug: 'nova_prime_set' },
    { input: '水男', slug: 'hydroid_prime_set' },
    { input: '母牛', slug: 'hildryn_prime_set' },
    { input: '男工程', slug: 'vauban_prime_set' },
    { input: '驴王', slug: 'oberon_prime_set' },
    { input: '蛆爹', slug: 'nidus_prime_set' },
    { input: '核弹猴', slug: 'wukong_prime_set' },
    { input: '一拳超人', slug: 'atlas_prime_set' },
    { input: '歌甲', slug: 'octavia_prime_set' },
    { input: '蝶甲', slug: 'titania_prime_set' },
    { input: '夜店', slug: 'revenant_prime_set' },
  ]
