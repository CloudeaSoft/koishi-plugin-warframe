...
- `rivenBaseValues.ts` exports `buildRivenAttrValueDict`. `rivenDisposition.ts`
  exports `buildWeaponRivenDispositionDict`. `relics.ts` exports
  `buildRelicDict`. Remaining static cache is `arbitrationSchedule` (L-030).
