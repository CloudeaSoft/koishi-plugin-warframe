...
| --- | --- | --- | --- | --- | --- | --- |
| L-028 | P1 | optimize | Turn remaining IIFE static caches (`rivenDisposition`, `relics`, `arbitrationSchedule`) into exported pure builders with unit tests | continuation of L-008 | todo | One module per iteration; start with `rivenDisposition` |
...
| ID | Type | Item | PR |
| --- | --- | --- | --- |
| L-008 | optimize | Export `buildRivenAttrValueDict` from `rivenBaseValues.ts` | (this change) |
