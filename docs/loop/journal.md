...
- PR: pending user approval (branch `cursor/explore-chinese-aliases-a29a`; nicknames corrected from CN sources)
- Validation: yarn build, yarn dtsc, yarn lint, yarn test — all green (61 files, 605 tests)
